...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComposePluginAccessors extends PluginFactory {
        private final ComposeCompilerPluginAccessors paccForComposeCompilerPluginAccessors = new ComposeCompilerPluginAccessors(providers, config);

        public ComposePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.compose.compiler</b>
         */
        public ComposeCompilerPluginAccessors getCompiler() {
            return paccForComposeCompilerPluginAccessors;
        }

    }

    public static class ComposeCompilerPluginAccessors extends PluginFactory {

        public ComposeCompilerPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>compose.compiler.plugin</b> with plugin id <b>org.jetbrains.compose.compiler</b> and
         * with version reference <b>compose</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("compose.compiler.plugin"); }
